...
Route::get('/criar/baralho',[DeckController::class,'create'])->name('criardeck');
Route::post('/gerar/baralho',[DeckController::class,'store'])->name('gerardeck');
Route::delete('/deletar/baralho/{id}',[DeckController::class,'destroy'])->name('deletardeck');
